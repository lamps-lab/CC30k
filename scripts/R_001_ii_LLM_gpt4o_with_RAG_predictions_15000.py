...
train_file = "cc25k/new_extended_train_set_llm_15000.csv"       
test_file = "cc25k/test_244_gt.csv"       
output_file = "cc25k/cc30k_244_predictions_gpt4o_RAG_15000.csv"
...
print(f"gpt4o_RAG_15000 (new 15000 WITH manually verified negatives) Predictions saved to {output_file}")
...
# train_file = "cc25k/new_extended_train_set_llm_15000.csv"       
# test_file = "cc25k/test_244_gt.csv"
# output_file = "cc25k/cc30k_244_predictions_gpt4o_RAG_fewshot_15000.csv"
...
# # ========= Save Predictions =========
# df_test.to_csv(output_file, index=False)
# print(f"gpt4o_RAG_fewshot_15000 (new 15000 WITH manually verified negatives) Predictions saved to {output_file}")
