...
lora_model_path = "cc25k/models/Meta-Llama-3-8B-cc30k-3000"
...
for context in df_test["input_context"]:
    ...
    # # Use top-k sampling or temperature
...
print(report)
print("llama3_ACTUALLY_zeroshot_3000 (new 3000 with manually verified negatives)")
df_test.to_csv(r"cc25k/cc30k_244_predictions_llama3_fine_tuned_3000.csv", index=False)
