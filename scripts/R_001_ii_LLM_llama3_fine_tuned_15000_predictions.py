...
lora_model_path = "cc25k/models/Meta-Llama-3-8B-cc30k-15000"
...
def build_prompt(context):
    ...
    return (
        f"<s>[INST] <<SYS>>\n{system_msg}\n<</SYS>>\n"
        f"Context:\n{context}\n"
        f"What is the reproducibility sentiment of this citation context?\n"
        f"[/INST]\nAnswer:"
    )
...
print(report)
print("LLAMA 15000 - zero shot - manaully verfied negatvies included")
df_test.to_csv(r"cc25k/cc30k_244_predictions_llama3_fine_tuned_15000.csv", index=False)
