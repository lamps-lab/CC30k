...
output_file = "cc25k/cc30k_244_predictions_gpt4o_RAG_3000.csv"
...
print(f"gpt4o_RAG_3000 zero shot Predictions saved to {output_file} - with new manually verified negatives - updated")
...
# # ========= Config =========
# client = OpenAI(api_key=os.getenv("OPENAI_API_KEY"))
# train_file = "cc25k/new_extended_train_set_llm_3000.csv"       # Must have 'text', 'label' columns
# test_file = "cc25k/test_244_gt.csv"       # Must have 'input_context', 'label_gt' columns
# output_file = "cc25k/cc30k_244_predictions_gpt4o_RAG_fewshot_3000.csv" #fewshot
...
# # ========= Save Predictions =========
# df_test.to_csv(output_file, index=False)
# # print(f"gpt4o_RAG_fewshot_9000 Predictions saved to {output_file}")
# print(f"gpt4o_RAG_fewshot_3000 Predictions saved to {output_file} - with new manually verified negatives - updated")
